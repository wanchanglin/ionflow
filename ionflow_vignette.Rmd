...
vignette: >
  %\VignetteIndexEntry{Ionflow: Ionomics data network and enrichment analysis}
...
```{r}
pre$data.gene.zscores %>% sample_n(10) %>%
  kable(caption = 'Pre-processed data', digits = 2) %>% 
  kable_styling(full_width = F, font_size = 10)

pre$data.gene.symb %>% sample_n(10) %>%
