...
GeneNetwork <- function(data = NULL, data_symb = NULL, 
  ...
  #' wl-28-07-2020, Tue: add an vertex attribute and use 'Set2' in RColorBrewer
  #'  but the max. number of colors is 8 in 'Set2' 
  ...
  res$plot.impact_betweenees <- im_be_p             # plot impact betweenees
